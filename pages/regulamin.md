...
1. **Klient** — osoba fizyczna, osoba prawna lub jednostka organizacyjna nieposiadająca osobowości prawnej, która zawiera lub zamierza zawrzeć umowę ze Sprzedawcą.
...
3. **Przedsiębiorca na prawach konsumenta (PnPK)** — osoba fizyczna zawierająca umowę bezpośrednio związaną z jej działalnością gospodarczą, gdy z treści tej umowy wynika, że nie ma ona dla tej osoby charakteru zawodowego (art. 385⁵, 556⁴, 556⁵ i 38a Kodeksu cywilnego oraz ustawy o prawach konsumenta). PnPK przysługują wybrane uprawnienia konsumenta w zakresie wskazanym w przepisach.
4. **Produkt** — dostępny w Sklepie towar: tumbler (kubek termiczny) ze stali nierdzewnej o pojemności 600 ml lub 900 ml, z podwójną ścianką, słomką i pokrywką, z nadrukiem sublimacyjnym w stylu pixel-art.
5. **Produkt personalizowany / na zamówienie** — Produkt wykonywany według indywidualnej specyfikacji Klienta lub służący zaspokojeniu jego zindywidualizowanych potrzeb, w szczególności z nadrukiem wybranym, skonfigurowanym, dostosowanym lub przesłanym przez Klienta (np. wybór konkretnego wzoru pixel-art, dodanie nicku, tekstu, grafiki). Nadruk powstaje dopiero po złożeniu zamówienia. Szczegóły dotyczące prawa odstąpienia w odniesieniu do tych Produktów reguluje § 9 oraz dokument **„Prawo odstąpienia od umowy"**.
6. **Umowa sprzedaży** — umowa zawierana między Klientem a Sprzedawcą za pośrednictwem Sklepu.
7. **Zamówienie** — oświadczenie woli Klienta zmierzające bezpośrednio do zawarcia Umowy sprzedaży, określające Produkty oraz ich liczbę i ewentualną konfigurację.
8. **Dni robocze** — dni od poniedziałku do piątku z wyłączeniem dni ustawowo wolnych od pracy w Polsce.

## § 3. Wymagania techniczne i zasady korzystania ze Sklepu

1. Do korzystania ze Sklepu wystarczające jest urządzenie z dostępem do internetu, aktualna przeglądarka internetowa oraz aktywne konto poczty elektronicznej.
2. Klient zobowiązany jest do korzystania ze Sklepu w sposób zgodny z prawem i dobrymi obyczajami, z poszanowaniem dóbr osobistych oraz praw własności intelektualnej osób trzecich. Zakazane jest dostarczanie treści o charakterze bezprawnym.
3. Jeżeli Klient przesyła lub wybiera treści służące personalizacji Produktu, oświadcza, że posiada do nich odpowiednie prawa i że nie naruszają one praw osób trzecich. Sprzedawca może odmówić realizacji Zamówienia, którego treść narusza prawo, prawa osób trzecich lub dobre obyczaje.

## § 4. Składanie i przyjmowanie Zamówień

1. Informacje o Produktach prezentowane w Sklepie, w szczególności ich opisy i ceny, stanowią zaproszenie do zawarcia umowy w rozumieniu art. 71 Kodeksu cywilnego, a nie ofertę.
2. Złożenie Zamówienia odbywa się poprzez dodanie Produktów do koszyka, wybór sposobu dostawy i płatności, podanie danych niezbędnych do realizacji oraz potwierdzenie zamówienia przyciskiem oznaczonym słowami **„Zamawiam z obowiązkiem zapłaty"** lub równoważnym (np. „Kupuję i płacę").
3. Kliknięcie przycisku, o którym mowa w ust. 2, stanowi złożenie przez Klienta oferty zawarcia Umowy sprzedaży.
4. Po złożeniu Zamówienia Sprzedawca niezwłocznie przesyła na adres e-mail Klienta potwierdzenie jego otrzymania. Umowa sprzedaży zostaje zawarta z chwilą otrzymania przez Klienta potwierdzenia przyjęcia Zamówienia do realizacji.
5. Warunkiem realizacji Zamówienia jest podanie prawdziwych i kompletnych danych. Składanie zamówień możliwe jest po założeniu konta lub bez rejestracji (jako gość) — wedle wyboru Klienta.
...
4. Konsument może złożyć oświadczenie o **obniżeniu ceny albo odstąpieniu od Umowy**, gdy:
   a) Sprzedawca odmówił lub nie doprowadził Produktu do zgodności z Umową;
   b) brak zgodności występuje nadal, mimo próby jej usunięcia;
...
2. Dane przetwarzane są w celu realizacji Zamówień, obsługi reklamacji oraz wykonania obowiązków prawnych, na zasadach opisanych w dokumencie **„Polityka prywatności"**.
3. Podanie danych jest dobrowolne, lecz niezbędne do zawarcia i wykonania Umowy.

## § 11. Pozasądowe sposoby rozpatrywania reklamacji i dochodzenia roszczeń

1. Konsument ma możliwość skorzystania z pozasądowych sposobów rozpatrywania reklamacji i dochodzenia roszczeń, m.in. przed stałym polubownym sądem konsumenckim oraz powiatowym (miejskim) rzecznikiem konsumentów. Szczegóły dostępne są m.in. na stronie Urzędu Ochrony Konkurencji i Konsumentów (UOKiK): [www.uokik.gov.pl](https://www.uokik.gov.pl).
2. Skorzystanie z tych metod jest dobrowolne i możliwe wyłącznie za zgodą obu stron sporu.
