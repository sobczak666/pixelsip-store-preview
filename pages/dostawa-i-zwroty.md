# Dostawa i zwroty — PIXEL SIP

> Twój loot w drodze. Tu szybki przegląd: ile czeka, ile kosztuje i co zrobić, gdy coś jest nie tak. Pełne zasady znajdziesz w Regulaminie i w dokumencie „Prawo odstąpienia od umowy".

---

## Dostawa

**Gdzie wysyłamy:** Polska.

**Czas realizacji = produkcja + wysyłka.** Twój tumbler z nadrukiem powstaje na zamówienie, więc najpierw go robimy, potem wysyłamy:

- **Produkcja (przygotowanie do wysyłki):** 2–4 dni robocze.
- **Czas u kuriera/paczkomatu:** 1–2 dni robocze.

W przypadku edycji limitowanych lub przedsprzedaży czas może być inny — informujemy o tym przy produkcie.

**Sposoby i koszty dostawy:**

| Sposób dostawy | Czas (orientacyjnie) | Koszt |
|---|---|---|
...
Dokładny koszt dostawy zawsze widzisz w koszyku, zanim klikniesz „Kupuję i płacę". Wszystkie ceny w PLN, brutto.
